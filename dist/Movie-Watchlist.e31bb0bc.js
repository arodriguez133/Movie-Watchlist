...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/Movie.js":[function(require,module,exports) {
"use strict";
...
exports.Movie = Movie;
},{}],"src/api/getData.js":[function(require,module,exports) {
"use strict";
...
function getMovie(movieTitle) {
  return fetch("https://www.omdbapi.com/?t=".concat(movieTitle, "&apikey=3861f60e")).then(function (res) {
    return res.json();
  }).then(function (data) {
    return data;
  });
...
exports.placeHolderHtml = void 0;
var placeHolderHtml = "\n          <i class=\"fa-solid fa-film\"></i>\n          <p>Start Exploring</p>\n";
exports.placeHolderHtml = placeHolderHtml;
...
var _Movie = require("./src/Movie.js");
var _getData = require("./src/api/getData.js");
...
searchBtn.addEventListener("click", function (e) {
  ...
  (0, _getData.getMovie)(searchInput.value).then(function (res) {
    ...
    var movieInfo = new _Movie.Movie(res);
...
},{"./src/Movie.js":"src/Movie.js","./src/api/getData.js":"src/api/getData.js","./src/utils.js":"src/utils.js","gsap":"node_modules/gsap/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Movie-Watchlist.e31bb0bc.js.map